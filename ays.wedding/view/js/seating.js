   ...
   $(document).ready(function(){
    var i=0;
     $('#select_table').change(function(){
      var cat = "";
      var num_table =$('#replyNumber').val();
      var shape= $(this).val();
      console.log(shape);
      console.log(num_table);
      switch(shape){

        case 1:   cat= "Rectangle"

        case 2:   cat= " Circle ";

        case 3:   cat= " Rectangle ";
      ...
      //tetragon trapezi
        if((shape == 1) && (num_table=>1))
        {
          var table_tada=[];
          
          for(i=0; i<num_table; i++)
          {
            var data = {"key":i,"category":"TableR3","name":"Head 1", "guests":{}, "loc":"143.5 58"};
              table_tada.push(data);
          ...
          myDiagram.model = new go.GraphLinksModel(table_tada);
        ...
        //stroggilo trapezi
        if((shape == 2) && (num_table=>1))
        {
          var table_tada=[];
          
          for(i=0; i<num_table; i++)
          {
            var data = {"key":i,"category":"TableC8", "name":"Head 2", "guests":{}, "loc":"324.5 58"};
              table_tada.push(data);
          ...
          // myDiagram.model = new go.GraphLinksModel([{"key":2, "category":"TableC8", "name":"Head 2", "guests":{}, "loc":"324.5 58"}]);
         
          //tetragono trapezi me perisoteres karekles
         if((shape == 3) && (num_table=>1))
        {
          var table_tada=[];
          
          for(i=0; i<num_table; i++)
          {
            var data = {"key":i, "category":"TableR8", "name":"3", "guests":{}, "loc":"121.5 203.5"};
              table_tada.push(data);
    ...
    myDiagram.nodeTemplateMap.add("",  // default template, for people
      $(go.Node, "Auto",
        ...
        $(go.Panel, "Viewbox",
          ...
          $(go.TextBlock, { margin: 2, desiredSize: new go.Size(60, NaN), textAlign: "center", stroke: "darkblue" },
    ...
    myDiagram.model = new go.GraphLinksModel([
     ...
     {"key":1, "category":"TableR3", "name":"Head 1", "guests":{}, "loc":"143.5 58"},
      ...
      {"key":4, "category":"TableC8", "name":"4", "guests":{}, "loc":"364.5 223.5"},
       {"key":5, "category":"TableC8", "name":"5", "guests":{}, "loc":"364.5 223.5"}
