 <?php 
   ...
   include '../../model/alert_function_generator.php';
   ...
   //Print sections list
    function pool()
    {
        ...
        foreach($section_result as $stixeia1)
        {
             ...
             $pool = "SELECT * FROM generator WHERE Section_ID = '$section_id'";
             $pool_result= $dbh->query($pool);
            
            foreach($pool_result as $stixeia)
            {
            $pools_id=$stixeia['generator_id'];
        ...
        <br>
             ...
             <div class="panel panel-default">
              ...
              <select required name="pools" style="width:50%"; id="pools">
               <option selected value="" >Generator</option>
                       <?php pool(); ?>
