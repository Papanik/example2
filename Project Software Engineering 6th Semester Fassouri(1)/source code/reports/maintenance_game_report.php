...
//----------------pool---------------------------
  ...
  $pools=$dbh->query("select * from games  where game_id ='$game_id' ");
  ...
  $pool_description=$dbh->query("select * from pool_description  where id ='$game_id' AND type='2'");
...
$pool_description=$dbh->query("select * from pool_description  where id ='$id_game' AND type='2' AND year='$now_date' ");
