...
//----------------pool---------------------------
  ...
  $pools=$dbh->query("select * from pools  where pools_id ='$pool_id' ");
  ...
  $pool_description=$dbh->query("select * from pool_description  where id ='$pool_id' AND type='1'  ");
...
$pool_description=$dbh->query("select * from pool_description  where id ='$pool_id' AND type='1' AND year='$now_date' ");
